...
const Upload = () => {
  ...
  return (
    <div className="flex w-full h-full absolute left-0 top-[60px] mb-10 pt-10 lg:pt-20 bg-[#F8F8F8] justify-center">
      <div className="bg-white rounded-lg xl:h-[80vh] flex gap-6 flex-wrap justify-between items-center p-14 pt-6 xl:w-[60%]">
        <div>
          <div>
        ...
        <div className="flex flex-col gap-3 pb-10">
          ...
          <div className="flex gap-6 mt-10">
            <button
              onClick={() => {}}
              className="border-gray-300 border-2 text-md font-md p-2 rounded w-28 lg:w-44 outline-none"
            >
              Discard
            </button>
            <button
              onClick={handlePost}
              className="bg-[#F51997] text-white border-2 text-md font-md p-2 rounded w-28 lg:w-44 outline-none"
            >
              Post
            </button>
          </div>
